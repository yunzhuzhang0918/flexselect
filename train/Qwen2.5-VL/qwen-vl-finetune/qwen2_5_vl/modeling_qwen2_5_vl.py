...
class Qwen2_5_VisionRotaryEmbedding(nn.Module):
    ...
    def forward(self, seqlen: int) -> torch.Tensor:
        seq = torch.arange(seqlen, device=self.inv_freq.device).float()
...
class Qwen2_5_Token_Selector_External(Qwen2_5_VLPreTrainedModel):
    ...
    def __init__(self, config: Qwen2_5_VLConfig):
        ...
        self.rope_scaling = config.rope_scaling = {"beta_fast": 32.0, "beta_slow": 1.0, "factor": 4.0, "mrope_section": [8, 12, 12], "rope_type": "yarn", "type": "yarn"}
        ...
        drop_func = globals()[drop_func_name]
        self.layers[-1].token_selection_pe =  types.MethodType(drop_func,  self.layers[-1])
        self.layers[-1].mrope_section = [8, 12, 12]
...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    ...
    def __init__(self, config, *inputs, **kwargs) -> None:
        ...
        if hasattr(config, "token_selector_hidden_size"):
    ...
    def forward(self, hidden_states: torch.Tensor, grid_thw: torch.Tensor) -> torch.Tensor:
        ...
        if self.merger_token_selector is not None:
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.token_selector_teacher = Qwen2_5_Token_Selector(config=config, bigger_model=self.model)
        self.token_selector =  Qwen2_5_Token_Selector_External(config=config.token_selector_config)
        self.config = config
    ...
    def forward(
        ...
        loss = spearmanr(pred=text_guide_score, target=text_guide_score_teacher)
