...
class LazySupervisedDataset(Dataset):
    ...
    def process_video(self, video_file):
        ...
        # )
        # print("target_frames:", target_frames, "num_frames_to_sample:",num_frames_to_sample, "avg_fps:", avg_fps, "total_frames:", total_frames)
        target_frames = 128#self.data_args.max_frame
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        try:
            sample = self._get_item(i)
            return sample
        except (DECORDError, Exception) as e:
