...
class InternVLChatConfig(PretrainedConfig):
    ...
    def to_dict(self):
        ...
        if "token_selector_config" in output and not isinstance(output["token_selector_config"], dict):
            output["token_selector_config"] = output["token_selector_config"].to_dict()
